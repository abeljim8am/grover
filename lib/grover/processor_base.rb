...
class Grover
  #
  # Shared process management functionality for Processor and BatchProcessor
  #
  module ProcessorBase
    ...
    def call_js_method(*args) # rubocop:disable Metrics/AbcSize, Metrics/MethodLength
      stdin.puts JSON.dump(args)
      input = stdout.gets
    ...
    def process_result(result)
      ...
      if result.is_a?(Hash) && result['type'] == 'base64'
